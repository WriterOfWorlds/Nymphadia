package net.mcreator.nymphadia.client.model;
...
public class Modelnymph<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("nymphadia", "modelnymph"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bipedHead = partdefinition.addOrReplaceChild("bipedHead",
				CubeListBuilder.create().texOffs(2, 1).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(27, 46)
		...
		PartDefinition horn2_r1 = bipedHead.addOrReplaceChild("horn2_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(1.0F, -11.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition horn1_r1 = bipedHead.addOrReplaceChild("horn1_r1",
				CubeListBuilder.create().texOffs(0, 18).addBox(-3.0F, -11.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, 0.2559F, 0.056F, -0.211F));
		PartDefinition ear = bipedHead.addOrReplaceChild("ear",
				CubeListBuilder.create().texOffs(24, 22).addBox(-0.0719F, -1.0F, -0.6476F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(28, 18).addBox(0.9281F, -1.0F, -0.6476F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 23)
		...
		PartDefinition ear2 = bipedHead.addOrReplaceChild("ear2",
				CubeListBuilder.create().texOffs(24, 18).addBox(-0.6216F, -1.0F, 0.1105F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 0)
		...
		PartDefinition bipedBody = partdefinition.addOrReplaceChild("bipedBody",
				CubeListBuilder.create().texOffs(28, 30).addBox(-3.0F, 0.0F, -2.0F, 6.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition bipedBody_r1 = bipedBody.addOrReplaceChild("bipedBody_r1",
				CubeListBuilder.create().texOffs(27, 0).addBox(1.0F, -21.0F, -11.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bipedBody_r2 = bipedBody.addOrReplaceChild("bipedBody_r2",
				CubeListBuilder.create().texOffs(37, 4).addBox(-4.0F, -21.0F, -11.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, -0.3924F, 0.0167F, 0.0403F));
		PartDefinition bipedRightArm = partdefinition.addOrReplaceChild("bipedRightArm",
				CubeListBuilder.create().texOffs(46, 12).addBox(-0.8264F, -1.0152F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bipedLeftArm = partdefinition.addOrReplaceChild("bipedLeftArm",
				CubeListBuilder.create().texOffs(20, 34).addBox(-1.1736F, -1.0152F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 1.5F, 0.0F, 0.0F, 0.0F, -0.1745F));
		PartDefinition bipedRightLeg = partdefinition.addOrReplaceChild("bipedRightLeg",
				CubeListBuilder.create().texOffs(0, 34).addBox(-1.0F, 0.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));
		PartDefinition bipedLeftLeg = partdefinition.addOrReplaceChild("bipedLeftLeg",
				CubeListBuilder.create().texOffs(32, 14).addBox(-2.0F, 0.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));
