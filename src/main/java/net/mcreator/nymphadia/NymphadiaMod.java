 ...
 *
 */
package net.mcreator.nymphadia;
...
@Mod("nymphadia")
public class NymphadiaMod {
	public static final Logger LOGGER = LogManager.getLogger(NymphadiaMod.class);
	public static final String MODID = "nymphadia";
